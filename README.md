...
To use the Swagger system we decorate our REST API methods with a call to *@swagger.operaion(...)* A decorator in Python is a way of 'wrapping' a function with additional functionality without having to modify the decorated function. 
